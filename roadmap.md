...
- [x] Consolidate the Truck Profile form into Settings and route Board plus the Truck tab there.
- [x] Replace the cold-open animation with the founder-specified truck-to-chart sequence.
